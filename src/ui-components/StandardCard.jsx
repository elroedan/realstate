...
export default function StandardCard(props) {
  const { realstate, overrides, ...rest } = props;
  return (
    <Flex
      gap="0"
      direction="column"
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${realstate?.bedrooms}${"bds "}${
              realstate?.bathrooms
            }${"bth "}${realstate?.area}${" sqft"}`}
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={`${realstate?.streetAddress}${" "}${
              realstate?.city
            }${", "}${realstate?.country}`}
